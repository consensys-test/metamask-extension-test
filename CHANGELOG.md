...
- chore: update yarn.lock to use branch ref instead of SHA
...
- feat: add squash merge scenario for 13.9.0 (#21)
- feat: cover regular merge scenario for 13.9.0 (#20)

### Fixed

- fix: document emergency hotfix for 13.9.0
...
[Unreleased]: https://github.com/consensys-test/metamask-extension-test/compare/v13.10.0...HEAD
[13.10.0]: https://github.com/consensys-test/metamask-extension-test/compare/v13.7.0...v13.10.0
